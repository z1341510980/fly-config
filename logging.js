import { C as CONFIGURATOR, c as checkChromeRuntimeError, q as bytesToSize, F as FC, r as millitime } from './common.js';
import { G as GUI, d as MSP, e as MSPCodes, T as TABS } from './js/main.js';
...
logging.initialize = function (callback) {
    ...
    function process_html() {
        ...
        const result = get('logging_file_entry');
            ...
            chrome.fileSystem.getWritableEntry(fileEntry, function(fileEntryWritable) {
                ...
                chrome.fileSystem.isWritableEntry(fileEntryWritable, function(isWritable) {
                    if (isWritable) {
                        ...
                        set({'logging_file_entry': chrome.fileSystem.retainEntry(fileEntry)});
