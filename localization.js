...
import { B as Backend } from './i18next-xhr-backend.js';
...
i18n.changeLanguage = function(languageSelected) {
    set({'userLanguageSelect': languageSelected});
...
function getStoredUserLocale(cb) {
    ...
    const result = get('userLanguageSelect');
...
export { get as g, i18n as i, set as s };
