...
import { o as isExpertModeEnabled, d as MSP, e as MSPCodes, m as mspHelper, T as TABS, G as GUI, t as tracking, n as have_sensor } from './js/main.js';
import { F as FC, d as API_VERSION_1_44, e as API_VERSION_1_45, A as API_VERSION_1_42, m as isInt, M as Model, n as degToRad, b as API_VERSION_1_43 } from './common.js';
...
function getColorForPercentage(percentage, colorTableOverride = null) {
        ...
        function redrawThrottleCurve(forced = false) {
            ...
            */
            ...
            if (mid >= parseFloat(throttleMidE.prop('min')) &&
                ...
                expo <= parseFloat(throttleExpoE.prop('max'))) ; else {
                return;
            }
