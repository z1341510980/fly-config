import { i as i18n, s as set, g as get } from './localization.js';
import { G as GUI, d as MSP, e as MSPCodes, T as TABS, p as updateTabList, m as mspHelper, D as DarkTheme, t as tracking } from './js/main.js';
import { M as Model, F as FC, n as degToRad, f as API_VERSION_1_46, b as API_VERSION_1_43, d as API_VERSION_1_44, e as API_VERSION_1_45, C as CONFIGURATOR, h as bit_check, A as API_VERSION_1_42 } from './common.js';
import { R as RateCurve } from './RateCurve.js';
...
import { b as Clock } from './three.js';
...
receiver.initialize = function (callback) {
    ...
    function lookupElrsBindingPhrase(uidString) {
        const bindingPhraseMap = get('binding_phrase_map').binding_phrase_map || {};
    ...
    function saveElrsBindingPhrase(uidString, bindingPhrase) {
        ...
        set({'binding_phrase_map': bindingPhraseMap});
      }
    ...
    function process_html() {
        ...
        rxRefreshRate.change(function () {
            ...
            // save update rate
            set({'rx_refresh_rate': plotUpdateRate});
            ...
            function update_ui() {
                ...
                widthScale = linear().domain([samples - 299, samples]);

                heightScale = linear().domain([800, 2200]);
        ...
        const result = get('rx_refresh_rate');
