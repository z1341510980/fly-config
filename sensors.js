...
import { G as GUI, n as have_sensor, d as MSP, e as MSPCodes, b as serial, T as TABS } from './js/main.js';
import { F as FC, f as API_VERSION_1_46 } from './common.js';
import './d3-transition.js';
import './d3-zoom.js';
import { $ } from './jquery.js';
import { s as semver } from './semver.js';
import { D as DEBUG } from './debug.js';
import { m as max, e as extent } from './d3-array.js';
...
sensors.initialize = function (callback) {
    ...
    $('#content').load("./tabs/sensors.html", function load_html() {
        ...
        $('.tab-sensors .info .checkboxes input').change(function () {
            ...
            set({'graphs_enabled': _checkboxes});
        });
        ...
        $('.tab-sensors .rate select, .tab-sensors .scale select').change(function () {
            ...
            if (['gyro_refresh_rate', 'accel_refresh_rate', 'mag_refresh_rate'].includes($(this).attr('name'))) {
                ...
                fastest = max([rates.gyro, rates.accel, rates.mag]);
            }

            // store current/latest refresh rates in the storage
            set({'sensor_settings': {'rates': rates, 'scales': scales}});
        ...
        const result = get('sensor_settings');
        ...
        const resultGraphs = get('graphs_enabled');
